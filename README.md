...
This project is part of my learning journey in Software Testing and Quality Assurance. As a university student, I wanted to gain practical experience with API testing by working with a real-world REST API. I chose the Trello REST API because it provides a wide range of endpoints for managing boards, lists, and cards, making it a great platform to understand RESTful services.

The primary goal of this project was to learn how APIs work, perform functional testing, validate responses, and automate API test cases using Postman.
